...
public class CurrencyConversionInfo_ implements Serializable
{
    ...
    private final static long serialVersionUID = -5753434262194988793L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public CurrencyConversionInfo_() {
    }
     ...
     * @param exchangeRate
     */
    public CurrencyConversionInfo_(int exchangeRateCode, int exchangeRate, int numberOfDecimalPlaces) {
        super();
